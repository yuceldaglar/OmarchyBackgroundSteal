...
Component docs for Omarchy Backgrounds (WinUI 3).

| Component | Doc | Project |
|---|---|---|
| Shell | [shell.md](shell.md) | `src/OmarchyBackgrounds.App` |
| Catalog + CatalogService | [catalog.md](catalog.md) | `src/OmarchyBackgrounds.Catalog` |
| Theme Scraper | [scraper.md](scraper.md) | `src/OmarchyBackgrounds.Scraper` |
